<template>
  <div class="container px-5 md:px-0">
    ...
    <p>
      ...
      provided by Fitz Creative at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at Envelope unless otherwise
    ...
    <p>
      ...
      not limited to Name, email address, birthday. The information that we
    ...
    <p>
      ...
      hesitate to contact us at admin@envelope.app.
    </p>
  </div>
</template>
